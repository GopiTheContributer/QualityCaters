...
<head>
    ...
    <title>Application | Triangle</title>
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown"><a href="blog.html">Page1 <i class="fa fa-angle-down"></i></a>
                            <ul role="menu" class="sub-menu">
                                <li><a href="#">Lorem ipsum dolor</a></li>
                                <li><a href="#">Lorem ipsum dolor</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="portfolio.html">Page2 <i class="fa fa-angle-down"></i></a>
                            <ul role="menu" class="sub-menu">
                                <li><a href="#">Lorem ipsum dolor</a></li>
                                <li><a href="#">Lorem ipsum dolor</a></li>
                            </ul>
    ...
    <section id="map-section">
        <div class="container">
		<div class="col-md-8">
            <form id="main-contact-form" name="" method="post" action="">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="copyright-text text-center">
                        <p>&copy; Your Company 2018. All Rights Reserved.</p>
                        <p>Designed by <a target="_blank" href="#">Gopi</a></p>
                    </div>
                </div>
            </div>
        </div>
