...
<section id="services" style="background-image:url(images/whyus.jpg);background-repeat:no-repeat;background-position: center top; min-widht:100%;min-height:100%;overflow:visible;position: relative;vertical-align: top;"> <!-- Catering Services -->
...
<!--/#action-->
<a href="" id="gallery"></a>
<section id="features" class="carosel-design">
  <div class="container">
    <!-- align-right col-sm-offset-1 -->
...
<!--/#footer-->
<a href="javascript:void(0);" class="back-to-top cd-is-visible cd-fade-out"><i class="fa fa-long-arrow-up" aria-hidden="true"></i></a>
